...
<html>
	...
	<body>
		<form>
			...
			<p><button formaction="/5">5) Surface Area under 501 Population over 100K</button></p>
			<p><button formaction="/6">6) Con Mon Surface Area over 200 LifeExp over 75</button></p>
			<p><button formaction="/7">7) Cities in Buenos Aires Pop over 500k</button></p>
